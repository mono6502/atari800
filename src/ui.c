...
static void SystemSettings(void)
{
	...
	static UI_tMenuItem ramxl_menu_array[] = {
		...
		UI_MENU_ACTION_TIP(192, "192 KB (Karen)", "ANTIC-CPU  Bits:_6**32__  Banks:8 "),
		UI_MENU_ACTION_TIP(MEMORY_RAM_256_RAMBO, "256 KB (Rambo XL)", "ANTIC+CPU  Bits:_65*32__  Banks:12"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_256_RAMBO_TOMS, "256 KB (TOMS)", "ANTIC+CPU  Bits:_65*32__  Banks:12"),
		...
		UI_MENU_ACTION_TIP(MEMORY_RAM_576_RAMBO_TFHH, "576 KB (TFHH)", "ANTIC+CPU  Bits:765*32__  Banks:32"),
		...
		UI_MENU_ACTION_TIP(1088, "1088 KB", "ANTIC+CPU  Bits:765*321_  Banks:64"),
		UI_MENU_END
	};
