...
static void SystemSettings(void)
{
	...
	static UI_tMenuItem ramxl_menu_array[] = {
		...
		UI_MENU_ACTION_TIP(128, "128 KB", "ANTIC-CPU  Bits:__**32__  Banks:4 "),
		UI_MENU_ACTION_TIP(MEMORY_RAM_192_RAMBO, "192 KB (Rambo XL)", "ANTIC+CPU  Bits:_6_*32__  Banks:8 "),
		UI_MENU_ACTION_TIP(MEMORY_RAM_192_KAREN, "192 KB (Karen)", "ANTIC-CPU  Bits:_6**32__  Banks:8 "),
		UI_MENU_ACTION_TIP(MEMORY_RAM_256_NEWELL, "256 KB (Newell)", "ANTIC+CPU  Bits:_65*32__  Banks:12"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_256_TOMS, "256 KB (TOMS)", "ANTIC+CPU  Bits:_65*32__  Banks:12"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_320_RAMBO, "320 KB (Rambo XL)", "ANTIC+CPU  Bits:_65*32__  Banks:16"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_320_COMPY_SHOP, "320 KB (Compy Shop)", "ANTIC-CPU  Bits:76**32__  Banks:16"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_576_TFHH, "576 KB (TFHH)", "ANTIC+CPU  Bits:765*32__  Banks:32"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_576_RAMBO, "576 KB (Rambo XL)", "ANTIC+CPU  Bits:_65*321_  Banks:32"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_576_COMPY_SHOP, "576 KB (Compy Shop)", "ANTIC-CPU  Bits:76**321_  Banks:32"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_1088_RAMBO, "1088 KB (Rambo XL)", "ANTIC+CPU  Bits:765*321_  Banks:64"),
		UI_MENU_ACTION_TIP(MEMORY_RAM_1088_NEWELL, "1088 KB (Newell)", "ANTIC-CPU  Bits:765*321_  Banks:64"),
		UI_MENU_END
	};
