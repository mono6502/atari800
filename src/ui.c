...
static void SystemSettings(void)
{
	...
	static UI_tMenuItem ramxl_menu_array[] = {
		...
		UI_MENU_ACTION_TIP(256, "256 KB (Rambo XL)", "ANTIC+CPU  Bits:_65-32__  Banks:12"),
		...
		UI_MENU_ACTION_TIP(MEMORY_RAM_576_RAMBO_TFHH, "576 KB (TF_HH)", "ANTIC+CPU  Bits:765-32__  Banks:32"),
